  ...
  return (
    <div className="container mx-auto px-4 py-8" style={{ maxWidth: '1000px' }}>
      ...
      <div style={{ marginBottom: '24px', display: 'flex', alignItems: 'center', gap: '8px', fontSize: '14px', color: '#1e293b' }}>
        ...
        <Link to="/vehicles" style={{ color: '#1e293b', textDecoration: 'none' }}>Vehicles</Link>
        <ChevronRight size={16} />
          ...
          {motStatus && (
            <div style={{
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
                ...
                <div>
                  <div style={{ fontSize: '13px', color: '#1e293b', marginBottom: '4px' }}>MOT</div>
          ...
          {insuranceStatus && (
            <div style={{
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
                ...
                <div>
                  <div style={{ fontSize: '13px', color: '#1e293b', marginBottom: '4px' }}>Insurance</div>
          ...
          {taxStatus && (
            <div style={{
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
                ...
                <div>
                  <div style={{ fontSize: '13px', color: '#1e293b', marginBottom: '4px' }}>Road Tax</div>
